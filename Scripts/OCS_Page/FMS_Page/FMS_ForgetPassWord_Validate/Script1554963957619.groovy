...
WebUI.click(findTestObject('FMs_OR_ForgetPw/Page_Healthcare Manager/a_Forgotten PIN'))

WebUI.verifyElementPresent(findTestObject('FMs_OR_ForgetPw/Page_Healthcare Manager/div_Please visit your mail inbox for get your new Pin'), 
    10)
